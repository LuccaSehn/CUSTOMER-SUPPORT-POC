...
from state import StatePartFour
from tools import (
...
def user_info(state: StatePartFour):
    return {"user_info": fetch_user_flight_information.invoke({})}


builder = StateGraph(StatePartFour)
...
def pop_dialog_state(state: StatePartFour) -> dict:
...
# image_path = os.path.join(image_directory, "graph_image.png")
